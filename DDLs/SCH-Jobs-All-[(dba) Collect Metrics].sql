...
/****** Object:  Job [(dba) Collect Metrics]    Script Date: 19-Sep-20 11:39:19 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Data Collector]    Script Date: 19-Sep-20 11:39:19 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Collect Metrics - dm_os_sys_memory]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
', 
		...
		@flags=8
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Collect Metrics - dm_os_process_memory]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
', 
		...
		@flags=8
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Collect Metrics - dm_os_performance_counters]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
', 
		...
		@flags=8
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Collect Metrics - dm_os_ring_buffers]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
', 
		...
		@flags=8
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Collect Metrics - dm_os_performance_counters_sampling]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
/****** Object:  Job [(dba) Collect Metrics - dm_os_memory_clerks]    Script Date: 19-Sep-20 11:39:20 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'(dba) Collect Metrics - dm_os_memory_clerks', 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Collect [dm_os_memory_clerks]]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
/****** Object:  Job [(dba) Collect Metrics - dm_os_performance_counters_deprecated_features]    Script Date: 19-Sep-20 11:39:20 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Data Collector]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'(dba) Collect Metrics - dm_os_performance_counters_deprecated_features', 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Collect Metrics - Deprecated Features]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
/****** Object:  Job [(dba) Collect Metrics - dm_os_performance_counters_sampling]    Script Date: 19-Sep-20 11:39:20 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Data Collector]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'(dba) Collect Metrics - dm_os_performance_counters_sampling', 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [(dba) Collect Metrics]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
/****** Object:  Job [(dba) Collect Metrics - dm_os_ring_buffers]    Script Date: 19-Sep-20 11:39:20 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Data Collector]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
/****** Object:  Job [(dba) Collect Metrics - dm_os_sys_info]    Script Date: 19-Sep-20 11:39:20 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Data Collector]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'(dba) Collect Metrics - dm_os_sys_info', 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Collect Metrics - dm_os_sys_info]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
/****** Object:  Job [(dba) Collect Metrics - NonSqlServer Perfmon Counters]    Script Date: 19-Sep-20 11:39:20 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Data Collector]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
https://docs.microsoft.com/en-us/windows/win32/perfctrs/counterdata?redirectedfrom=MSDN', 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [truncate table [dbo].[CounterData]]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
IF @_errorMessage IS NOT NULL
	THROW 50000, @_errorMessage, 1;', 
		...
		@flags=8
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [NonSqlServer Perfmon Counters]    Script Date: 19-Sep-20 11:39:20 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'NonSqlServer Perfmon Counters', 
		...
		@flags=8
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Populate dbo.dm_os_performance_counters_nonsql]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
/****** Object:  Job [(dba) Collect Metrics - Purge Aggregated Tables]    Script Date: 19-Sep-20 11:39:20 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Data Collector]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'(dba) Collect Metrics - Purge Aggregated Tables', 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Purge [dbo].[dm_os_memory_clerks_aggregated]]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
begin
	...
	set @r = @@ROWCOUNT;
		...
		@flags=8
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Purge [dbo].[dm_os_performance_counters_aggregated_90days]]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
select @date_filter_lower = (select * from dbo.aggregate_time(min(collection_time),@time_interval_minutes*2)) from [dbo].[dm_os_performance_counters_aggregated_90days] where collection_time < @date_filter;
...
begin
	...
	begin
		...
		select	[collection_time] = aggregate_time,
		...
		cross apply dbo.aggregate_time(collection_time,@time_interval_minutes) as agt
		group by aggregate_time, server_name, [object_name], counter_name, instance_name, cntr_type
	...
	select @date_filter_lower = @date_filter_upper, @date_filter_upper = DATEADD(MINUTE,@time_interval_minutes*2,@date_filter_upper);
		...
		@flags=8
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Purge [dbo].[dm_os_performance_counters_aggregated_1year]]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
begin
	...
	set @r = @@ROWCOUNT;
		...
		@flags=8
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Purge [dbo].[dm_os_performance_counters_nonsql_aggregated_90days]]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
set @date_filter = CONVERT(date,DATEADD(day,-@retention_days,GETDATE()));
select @date_filter_lower = (select * from dbo.aggregate_time(min(collection_time),@time_interval_minutes*2)) from [dbo].[dm_os_performance_counters_nonsql_aggregated_90days] where collection_time < @date_filter;
set @date_filter_upper = DATEADD(MINUTE,@time_interval_minutes*2,@date_filter_lower);
...
begin
	...
	select @date_filter_lower = @date_filter_upper, @date_filter_upper = DATEADD(MINUTE,@time_interval_minutes*2,@date_filter_upper);
		...
		@flags=8
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Purge [dbo].[dm_os_performance_counters_nonsql_aggregated_1year]]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
begin
	...
	set @r = @@ROWCOUNT;
		...
		@flags=8
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Purge [dbo].[dm_os_process_memory_aggregated]]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
begin
	...
	set @r = @@ROWCOUNT;
		...
		@flags=8
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Purge [dbo].[dm_os_ring_buffers_aggregated]]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
begin
	...
	set @r = @@ROWCOUNT;
		...
		@flags=8
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Purge [dbo].[dm_os_sys_memory_aggregated]]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
begin
	...
	set @r = @@ROWCOUNT;
		...
		@flags=8
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Purge [dbo].[WaitStats_aggregated]]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
/****** Object:  Job [(dba) Collect Metrics - Purge Perfmon Files]    Script Date: 19-Sep-20 11:39:20 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Data Collector]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'(dba) Collect Metrics - Purge Perfmon Files', 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Delete PerfMon Files]    Script Date: 19-Sep-20 11:39:20 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Delete PerfMon Files', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'powershell.exe -ExecutionPolicy Bypass .  ''E:\Perfmon\perfmon-remove-imported-files.ps1'';', 
		@flags=8
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_update_job @job_id = @jobId, @start_step_id = 1
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
set @date_filter = CONVERT(date,DATEADD(day,-@retention_days,GETDATE()));
-- create lower limit
select @date_filter_lower = agt.aggregate_time
from ( select min(collection_time) as collection_time_min from [dbo].[dm_os_memory_clerks] where collection_time < @date_filter )as pc
cross apply dbo.aggregate_time(collection_time_min,@time_interval_minutes*2) as agt;
-- create upper limit
set @date_filter_upper = DATEADD(MINUTE,@time_interval_minutes*2,@date_filter_lower);
...
begin
	...
	begin
		...
		cross apply dbo.aggregate_time(collection_time,@time_interval_minutes) as agt
		group by aggregate_time, [memory_clerk];
...
set @date_filter = CONVERT(date,DATEADD(day,-@retention_days,GETDATE()));
select @date_filter_lower = (select aggregate_time from dbo.aggregate_time(min(collection_time),@time_interval_minutes*2)) from [dbo].[dm_os_performance_counters] where collection_time < @date_filter;
set @date_filter_upper = DATEADD(MINUTE,@time_interval_minutes*2,@date_filter_lower);
...
set @date_filter = CONVERT(date,DATEADD(day,-@retention_days,GETDATE()));
select @date_filter_lower = (select aggregate_time from dbo.aggregate_time(min(collection_time),@time_interval_minutes*2)) from [dbo].[dm_os_performance_counters_nonsql] where collection_time < @date_filter;
set @date_filter_upper = DATEADD(MINUTE,@time_interval_minutes*2,@date_filter_lower);
...
set @date_filter = CONVERT(date,DATEADD(day,-@retention_days,GETDATE()));
select @date_filter_lower = (select aggregate_time from dbo.aggregate_time(min(collection_time),@time_interval_minutes*2)) from [dbo].[dm_os_process_memory] where collection_time < @date_filter;
set @date_filter_upper = DATEADD(MINUTE,@time_interval_minutes*2,@date_filter_lower);
...
set @date_filter = CONVERT(date,DATEADD(day,-@retention_days,GETDATE()));
select @date_filter_lower = (select aggregate_time from dbo.aggregate_time(min(collection_time),@time_interval_minutes*2)) from [dbo].[dm_os_ring_buffers] where collection_time < @date_filter;
set @date_filter_upper = DATEADD(MINUTE,@time_interval_minutes*2,@date_filter_lower);
...
set @date_filter = CONVERT(date,DATEADD(day,-@retention_days,GETDATE()));
select @date_filter_lower = (select * from dbo.aggregate_time(min(collection_time),@time_interval_minutes*2)) from [dbo].[dm_os_sys_memory] where collection_time < @date_filter;
set @date_filter_upper = DATEADD(MINUTE,@time_interval_minutes*2,@date_filter_lower);
...
set @date_filter = CONVERT(date,DATEADD(day,-@retention_days,GETDATE()));
select @date_filter_lower = (select * from dbo.aggregate_time(min([Collection_Time]),@time_interval_minutes*2)) from [dbo].[WaitStats] where [Collection_Time] < @date_filter;
set @date_filter_upper = DATEADD(MINUTE,@time_interval_minutes*2,@date_filter_lower);
...
begin
	...
	begin
		...
		where [Collection_Time] in (	select MIN(ag.Collection_Time) 
										from #WaitStats_aggregated ag
										cross apply dbo.aggregate_time(ag.Collection_Time,@time_interval_minutes) as agt
										group by agt.aggregate_time
									);
...
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [DBA]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Purge-Data-Older-Than-60-Days]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
/****** Object:  Job [(dba) Collect Metrics - Wait Stats]    Script Date: 19-Sep-20 11:39:20 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Data Collector]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'(dba) Collect Metrics - Wait Stats', 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Collect Metrics - Wait Stats]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
/****** Object:  Job [(dba) Collect Metrics - Wait Stats Clearing]    Script Date: 19-Sep-20 11:39:20 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Data Collector]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'(dba) Collect Metrics - Wait Stats Clearing', 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Wait Stats Clearing]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
/****** Object:  Job [(dba) Collect Metrics - WhoIsActive]    Script Date: 19-Sep-20 11:39:20 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 19-Sep-20 11:39:20 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'(dba) Collect Metrics - WhoIsActive', 
	...
	Job will run every 2 Minutes once started.', 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Log activities with [sp_WhoIsActive]]    Script Date: 19-Sep-20 11:39:20 AM ******/
